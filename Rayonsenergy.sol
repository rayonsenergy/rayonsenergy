...
contract RAYONSENERGY is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 20000000000 * 10**_decimals;     // Supply do Token = 20 billions
    ...
    string private constant _name = "Rayons Energy";
    string private constant _symbol = "RAYONS";
